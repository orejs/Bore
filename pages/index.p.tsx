                ...
                <div className="max-w-2xl">
                  ...
                  <div className="mt-6 flex gap-6">
                    <a
                      ...
                      href="https://twitter.com/sengmitnick"
                    >
                      <svg
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                    ...
                    <a
                      ...
                      href="https://instagram.com/sengmitnick"
                    >
                      <svg
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                    ...
                    <a
                      ...
                      href="https://github.com/sengmitnick"
                    >
                      <svg
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                    ...
                    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
                      <h2 className="flex items-center text-sm font-semibold text-zinc-900 dark:text-zinc-100">
                        <svg
                          ...
                          height="24"
                        >
                          <path d="M770.016 332.768l-77.824 76.8s0-307.2-259.616-409.568c0 0-25.92 281.6-155.744 383.936-129.792 102.464-389.44 409.568 129.696 639.968 0 0-259.616-281.6 77.824-486.304 0 0-25.92 102.336 103.872 204.8 129.824 102.368 0 281.6 0 281.6s623.008-153.632 181.792-691.232z"></path>
                        </svg>
                      ...
                      <ol className="mt-6 space-y-4">
                        {!!articles?.length &&
                          articles.map((article) => (
                            <li className="flex gap-4" key={article.slug}>
                              <dl className="flex flex-auto flex-wrap gap-x-2">
                                <dt className="sr-only">Title</dt>
                                <dd className="w-full truncate flex-none text-sm font-medium text-zinc-900 dark:text-zinc-100">
                                  {article.title}
                                </dd>
                                ...
                                >
                                  <time dateTime="2019">{article.createdAt}</time>
                                </dd>
                              </dl>
                            </li>
                          ))}
